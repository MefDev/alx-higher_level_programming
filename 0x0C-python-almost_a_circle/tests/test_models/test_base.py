...
class TestBase(unittest.TestCase):
    ...
    def test_json_custom_values(self):
        ...
        self.assertEqual(
            dictionary, {'id': 7, 'width': 10, 'height': 7, 'x': 2, 'y': 8})
        self.assertEqual(type(dictionary), dict)
        self.assertEqual(
            json_dictionary, '[{"id": 7, "width": 10, "height": 7, "x": 2, "y": 8}]')
    ...
    def test_save_to_file_custom_values(self):
        ...
        self.assertEqual(Rectangle.save_to_file(
            [r1, r2]), '[{"id": 10, "width": 10, "height": 7, "x": 2, "y": 8}, {"id": 11, "width": 2, "height": 4, "x": 0, "y": 0}]')
